...
const DEFAULT_PREFIX = `You are Aris, an AI bot chat assistant.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Aris, an AI bot chat assistant, running within the Aris Agent SDK.`
const AGENT_SDK_PREFIX = `You are an Aris agent, built on the Aris Agent SDK.`
