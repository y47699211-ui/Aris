...
export type GlobalConfig = {
  ...
  // Aris bot chat credits. New users start with INITIAL_CREDITS (1000).
  // Decremented as the chat consumes API credits. Undefined means the user
  // has never been seeded (will be initialized on first read).
  arisCredits?: number
  arisCreditsInitialized?: boolean
